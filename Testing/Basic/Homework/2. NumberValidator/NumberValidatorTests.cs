...
public class NumberValidatorTests
{
    ...
    [TestCase("-99", 3, 2, false, TestName = "When value is integer with negative sign and scale non zero")]
    ...
    [TestCase("+0.0", 3, 1, false, TestName = "When value is zero with zero fraction and sign and separator dot")]
    [TestCase("0.000", 4, 3, true, TestName = "When value is zero with zero fraction and separator dot")]
    [TestCase("300.52", 5, 2, true, TestName = "When value is fraction and has separator dot")]
    [TestCase("+3.52", 15, 10, false, TestName = "When value is fraction and has sign and separator is dot")]
