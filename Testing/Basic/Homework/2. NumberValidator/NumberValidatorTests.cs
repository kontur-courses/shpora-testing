...
public class NumberValidatorTests
{
    ...
    public void NumberValidator_ShouldThrowArgumentException_WithIncorrectData(
    ...
    [TestCase(4, 2, false, "-1.24", ExpectedResult = true)]
    public bool NumberValidator_ShouldReturnTrue_WithCorrectData(
    ...
    public bool NumberValidator_ShouldReturnFalse_WithInCorrectData(
        int precision, int scale, bool onlyPositive, string number)
    {
        NumberValidator numberValidator = new NumberValidator(precision, scale, onlyPositive);
        return numberValidator.IsValidNumber(number);
